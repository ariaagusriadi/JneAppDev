    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('jnearchives/tata-usaha/format-pengajuan' , $format_pengajuan->id) }}" method="post"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="nama_dokumen" placeholder="nama dokumen" value="{{ $format_pengajuan->nama_dokumen }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <h5>File Dokumen</h5>
