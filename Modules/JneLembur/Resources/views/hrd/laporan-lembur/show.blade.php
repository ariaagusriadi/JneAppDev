        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <td>
                                    <a href="{{ url($laporan->file_formulir_v1) }}"
                                        class="btn btn-square btn-sm btn-outline-dark btn-rounded" target="blank_">Download
                                        Surat Perintah</a>
                                </td>
                            </tbody>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ url('jnelembur/hrd/laporan-lembur', $laporan->id) }}"
                                method="post">
                                @csrf
                                @method('put')
                                <button class="btn btn-danger ml-3"
                                    onclick="return confirm('menandatangi dan melaporkan laporan ke hrd')">TANDA TANGANI LAPORAN LEMBUR</button>
                            </form>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 mt-5">
                            @include('utils.backbutton', [
                                'url' => url('jnelembur/hrd/laporan-lembur'),
                            ])
                        </div>
                    </div>
                </div>
