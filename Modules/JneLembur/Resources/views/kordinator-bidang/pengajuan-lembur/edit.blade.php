    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('jnelembur/kordinator-bidang/pengajuan-lembur-baru' ,$pengajuan_lembur_baru) }}" method="post" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" class="form-control  @error('jabatan') is-invalid @enderror"
                                        name="jabatan" value="{{ $pengajuan_lembur_baru->jabatan }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="date"
                                        ...
                                        name="tanggal_pengajuan" value="{{ $pengajuan_lembur_baru->tanggal_pengajuan }}">
                                </div>
                            </div>
                        </div>
                        <div class="mt-3 mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="file"
                                        class="custom-file-input  @error('file_list_karayawan') is-invalid @enderror"
