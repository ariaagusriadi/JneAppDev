...
class HistoryMailController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('jnemail::DistribusiSurat.JrSuperVisior.DevisiKeuangan.history-mail.index', $data);
    ...
    public function show(PengirimanSurat $history_mail)
    {
        ...
        return view('jnemail::DistribusiSurat.JrSuperVisior.DevisiKeuangan.history-mail.show', $data);
    }
