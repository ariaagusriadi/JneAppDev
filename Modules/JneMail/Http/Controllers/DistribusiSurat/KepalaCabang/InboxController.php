...
class InboxController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('jnemail::DistribusiSurat.KepalaCabang.inbox.index', $data);
    }
    ...
    public function show(PengirimanSurat $inbox_mail)
    {
        ...
        return view('jnemail::DistribusiSurat.KepalaCabang.inbox.show', $data);
    }
    ...
    public function update(BalasanSuratRequest $request, PengirimanSurat $inbox_mail)
    {
        ...
        return redirect('jnemail/kepala-cabang/inbox-mail')->with('success', 'berhasil mengirim balasan surat ke ' . $inbox_mail->pegawai->nama);
    }

    public function read(PengirimanSurat $inbox_mail)
    {
        $inbox_mail->status = 903;
        ...
        return redirect('jnemail/kepala-cabang/read-mail')->with('warning', 'sudah di baca');
    }
}
