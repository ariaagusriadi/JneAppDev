                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h4>Balas Surat</h4>
                            <br>
                            <form action="{{ url('jnemail/custumer-service/inbox-mail', $inbox_mail->id) }}"
                ...
                <div class="row">
                    <div class="col-md-6 mt-5">
                        @include('utils.backbutton', [
                            'url' => url('jnemail/custumer-service/inbox-mail'),
                        ])
                    </div>
                    <div class="col-md-6 mt-5">
                        <form action="{{ url('jnemail/custumer-service/inbox-mail/tandai-telah-dibaca', $inbox_mail->id) }}"
                            method="post">
                            @method('put')
                            @csrf
                            <Button class="btn btn-danger btn-rounded" onclick="confirm('tandai telah di baca')">Tandai
                                telah Dibaca</Button>
                        </form>
                    </div>
                </div>
