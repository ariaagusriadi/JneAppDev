            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <dt>Nama Pengirim</dt>
                            <dd>{{ $history_mail->pegawai->nama }}</dd>
                        </div>
                        <div class="col-md-6">
                            <dt>Unit Pengirim</dt>
                            <dd>{{ $history_mail->unitkerja->nama_unit }}</dd>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <dt>Tujuan Pengiriman</dt>
                            <dd>{{ $history_mail->tujuan }}</dd>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <dt>subject</dt>
                            <dd>
                                <p> {!! nl2br($history_mail->subject) !!}</p>
                            </dd>
                        </div>
                    </div>
                    <div class="row">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <td class="text-center">
                                    <a href="{{ url($history_mail->file_surat) }}"
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-5">
                            @include('utils.backbutton', [
                                'url' => url('jnemail/jr-supervisior-devisi-operasional/history-mail'),
                            ])
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="DZ_W_TimeLine1" class="widget-timeline dz-scroll style-1 height370">
                        <ul class="timeline">
                            @foreach ($history_mail->logpengiriman->sortByDesc('created_at')->values() as $log)
                                <li>
