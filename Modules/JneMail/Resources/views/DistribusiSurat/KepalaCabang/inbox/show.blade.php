                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h4>Balas Surat</h4>
                            <br>
                            <form action="{{ url('jnemail/kepala-cabang/inbox-mail', $inbox_mail->id) }}" method="post"
                ...
                <div class="row">
                    <div class="col-md-6 mt-5">
                        @include('utils.backbutton', [
                            'url' => url('jnemail/kepala-cabang/inbox-mail'),
                        ])
                    </div>
                    <div class="col-md-6 mt-5">
                        <form
                            action="{{ url('jnemail/kepala-cabang/inbox-mail/tandai-telah-dibaca', $inbox_mail->id) }}"
                            method="post">
                            @method('put')
                            @csrf
