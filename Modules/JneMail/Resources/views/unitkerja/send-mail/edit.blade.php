...
@section('content')
    <h1>Edit Pengiriman Surat</h1>

    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                   Edit Pengiriman Surat
                </div>
                <div class="card-body">
                    <form action="{{ url('jnemail/unit-kerja/send-mail' , $send_mail->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="tujuan" value="{{ $send_mail->tujuan }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
