        ...
        <div class="col-md-6">
            <div class="card">
                    ...
                    <div class="row">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <td>
                                    <a href="{{ url($pengajuan_masuk->draft_surat_ttd) }}"
                                        class="btn btn-square btn-sm btn-outline-dark btn-rounded" target="blank_">Download
                                        Draft</a>
                                </td>
                            </tbody>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('jnesurat/ceo/pengajuan-masuk', $pengajuan_masuk->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col mt-3">
                                <div class="form-group">
                                    ...
                                    @include('utils.errors', ['item' => 'file_surat_pdf'])
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="custom-file">
                                            <input type="file"
                                                class="custom-file-input @error('file_surat_pdf') is-invalid @enderror"
                                                name="file_surat_pdf" accept=".pdf">
                        ...
                        <div class="row">
                            <div class="col mt-3">
                                <div class="form-group">
                                    ...
                                    @include('utils.errors', ['item' => 'keterangan_surat_ceo'])
                                    <textarea name="keterangan_surat_ceo" class="form-control @error('keterangan_surat_ceo') is-invalid @enderror"
                    ...
                    <div class="col-md-6">
                        <form action="{{ url('jnesurat/ceo/tolak-pengajuan', $pengajuan_masuk->id) }}" method="post"
                            class="d-inline">
                            @method('put')
                            @csrf
                ...
                <div class="row">
                    <div class="col-md-12 mt-5">
                        @include('utils.backbutton', [
                            'url' => url('jnesurat/ceo/pengajuan-masuk'),
                        ])
                    </div>
                </div>
            </div>
