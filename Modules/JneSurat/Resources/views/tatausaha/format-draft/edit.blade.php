    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('jnesurat/tata-usaha/format-draft', $format_draft->id) }}" method="post"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="nama_format_surat" value="{{ $format_draft->nama_format_surat }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
