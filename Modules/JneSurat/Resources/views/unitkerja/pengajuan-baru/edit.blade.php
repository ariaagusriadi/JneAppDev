...
@section('content')
    <h1>Edit Data Pengajuan Baru</h1>

    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    Edit Data Pengajuan Baru
                </div>
                <div class="card-body">
                    <form action="{{ url('jnesurat/unit-kerja/pengajuan-baru', $pengajuan_baru->id) }}" method="post"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="nama_pengajuan" value="{{ $pengajuan_baru->nama_pengajuan }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="keperluan_pengajuan" value="{{ $pengajuan_baru->keperluan_pengajuan }}">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" name="file_pengantar" accept=".pdf, .doc, .docx">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" name="file_lampiran" accept=".pdf, .doc, .docx">
                                            <label class="custom-file-label">Choose file</label>
                                        </div>
                                    </div>
                                </div>
